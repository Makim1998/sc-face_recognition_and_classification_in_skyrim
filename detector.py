...
for image_path in IMAGE_PATHS:
    ...
    detections['detection_boxes'] = detections['detection_boxes'][:2]
    detections['detection_classes'] = detections['detection_classes'][:2]
    detections['detection_scores'] = detections['detection_scores'][:2]
    ...
    print('Done')
    plt.savefig(os.path.join('results', os.path.basename(image_path)))
plt.show()
